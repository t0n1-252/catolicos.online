...
$(function () {
  ...
  $('body').on('click', '.js_emoji', function () {
    ...
    /* set the cursor position to the end of the emoji */
    textarea.prop('selectionStart', cursorPosition + emoji.length);
    textarea.prop('selectionEnd', cursorPosition + emoji.length);
    /* focus the textarea */
