...
/* modules */
api['modules/activities'] = ajax_path + "modules/activities.php";
...
$(function () {
  ...
  // handle activities
  /* permission request */
  $('body').on('click', '.js_activities-permission-request', function () {
    var _this = $(this);
    var id = _this.data('id');
    /* button loading */
    button_status(_this, "loading");
    /* post the request */
    $.post(api['modules/activities'], { 'do': 'permission_request', 'id': id }, function (response) {
      if (response.callback) {
        /* button reset */
        button_status(_this, "reset");
        eval(response.callback);
  ...
  $('body').on('click', '.js_activities-permission-decline', function () {
    var _this = $(this);
    var id = _this.data('id');
    /* button loading */
    button_status(_this, "loading");
    /* post the request */
    $.post(api['modules/activities'], { 'do': 'permission_decline', 'id': id }, function (response) {
      if (response.callback) {
        /* button reset */
        button_status(_this, "reset");
        eval(response.callback);
  ...
  /* permission accept (editor|viewer) */
  $('body').on('click', '.js_activities-permission-accept', function () {
    var _this = $(this);
    var id = _this.data('id');
    var permission = _this.data('permission');
    /* button loading */
    button_status(_this, "loading");
    /* post the request */
    $.post(api['modules/activities'], { 'do': 'permission_accept', 'id': id, 'permission': permission }, function (response) {
      if (response.callback) {
        /* button reset */
        button_status(_this, "reset");
        eval(response.callback);
  ...
  /* permission revoke */
  $('body').on('click', '.js_activities-permission-revoke', function () {
    var _this = $(this);
    var id = _this.data('id');
    /* button loading */
    button_status(_this, "loading");
    /* post the request */
    $.post(api['modules/activities'], { 'do': 'permission_revoke', 'id': id }, function (response) {
      if (response.callback) {
        /* button reset */
        button_status(_this, "reset");
        eval(response.callback);
  ...
  /* delete activity */
  $('body').on('click', '.js_activity-deleter', function () {
    var _this = $(this);
    var id = _this.data('id');
    confirm(__['Delete'], __['Are you sure you want to delete this?'], function () {
      $.post(api['modules/activities'], { 'do': 'delete', 'id': id }, function (response) {
        if (response.callback) {
          eval(response.callback);
        } else {
          /* reload */
