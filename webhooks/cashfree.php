  ...
  switch ($_GET['handle']) {
    ...
    case 'wallet':
      ...
      if ($payment) {
        ...
        /* log payment */
        $user->log_payment($user->_data['user_id'], $_SESSION['wallet_replenish_amount'], 'cashfree', 'wallet');
        /* redirect */
    ...
    case 'donate':
      ...
      if ($payment) {
        ...
        /* log payment */
        $user->log_payment($user->_data['user_id'], $_SESSION['donation_amount'], 'cashfree', 'donate');
        /* redirect */
    ...
    case 'subscribe':
      ...
      if ($payment) {
        ...
        /* log payment */
        $user->log_payment($user->_data['user_id'], $monetization_plan['price'], 'cashfree', 'subscribe');
        /* redirect */
        redirect($node_link);
      }
      break;
    ...
    case 'paid_post':
      ...
      if ($payment) {
        ...
        /* log payment */
        $user->log_payment($user->_data['user_id'], $post['post_price'], 'cashfree', 'paid_post');
        /* redirect */
        redirect($post_link);
      }
      break;
    ...
    case 'movies':
      ...
      if ($payment) {
        ...
        /* log payment */
        $user->log_payment($user->_data['user_id'], $movie['price'], 'cashfree', 'movies');
        /* redirect */
        redirect($movie_link);
      }
      break;
    ...
    case 'marketplace':
      ...
      if ($payment) {
        ...
        /* log payment */
        $user->log_payment($user->_data['user_id'], $orders_collection['total'], 'cashfree', 'marketplace');
        /* redirect */
