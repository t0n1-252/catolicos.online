    ...
    switch ($_GET['handle']) {
      case 'packages':
        ...
        if ($payment) {
          ...
          /* log payment */
          $user->log_payment($user->_data['user_id'], $package['price'], 'paystack', 'packages');
          /* redirect*/
          redirect("/upgraded");
        }
        break;
      ...
      case 'wallet':
        ...
        if ($payment) {
          ...
          /* log payment */
          $user->log_payment($user->_data['user_id'], $_SESSION['wallet_replenish_amount'], 'paystack', 'wallet');
          /* redirect*/
      ...
      case 'donate':
        ...
        if ($payment) {
          ...
          /* log payment */
          $user->log_payment($user->_data['user_id'], $_SESSION['donation_amount'], 'paystack', 'donate');
          /* redirect*/
      ...
      case 'subscribe':
        ...
        if ($payment) {
          ...
          /* log payment */
          $user->log_payment($user->_data['user_id'], $monetization_plan['price'], 'paystack', 'subscribe');
          /* redirect */
          redirect($node_link);
        }
        break;
      ...
      case 'paid_post':
        ...
        if ($payment) {
          ...
          /* log payment */
          $user->log_payment($user->_data['user_id'], $post['post_price'], 'paystack', 'paid_post');
          /* redirect */
          redirect($post_link);
        }
        break;
      ...
      case 'movies':
        ...
        if ($payment) {
          ...
          /* log payment */
          $user->log_payment($user->_data['user_id'], $movie['price'], 'paystack', 'movies');
          /* redirect */
          redirect($movie_link);
        }
        break;
      ...
      case 'marketplace':
        ...
        if ($payment) {
          ...
          /* log payment */
          $user->log_payment($user->_data['user_id'], $orders_collection['total'], 'paystack', 'marketplace');
          /* redirect */
